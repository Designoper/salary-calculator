class Nomina {
	constructor() {
		...
		this.SALARIO_BRUTO = {
			...
			FORMACION: this.FIXED_VALUES.PRECIO_HORA * this.FORM_ELEMENTS.HORAS.FORMACION,
			EVENTO: this.FORM_ELEMENTS.HORAS.EVENTO * (this.FIXED_VALUES.PRECIO_HORA + this.FIXED_VALUES.PLUS.EVENTO),
			AJUSTES: this.FORM_ELEMENTS.AJUSTES,
			NOCTURNIDAD:
				this.FIXED_VALUES.PRECIO_HORA *
			...
			AFLUENCIA: this.FORM_ELEMENTS.HORAS.AFLUENCIA * this.FIXED_VALUES.PLUS.AFLUENCIA * this.FIXED_VALUES.PRECIO_HORA,
			FESTIVO: this.FORM_ELEMENTS.HORAS.FESTIVO * this.FIXED_VALUES.PLUS.FESTIVO * this.FIXED_VALUES.PRECIO_HORA,
			FESTIVO_ESPECIAL: this.FORM_ELEMENTS.HORAS.FESTIVO_ESPECIAL * this.FIXED_VALUES.PLUS.FESTIVO_ESPECIAL * this.FIXED_VALUES.PRECIO_HORA,
			VACACIONES: this.FORM_ELEMENTS.VACACIONES.HORAS_SEMANA / this.FIXED_VALUES.VACACIONES.DIAS_SEMANA * this.FORM_ELEMENTS.VACACIONES.DIAS * this.FIXED_VALUES.PRECIO_HORA,
			HORAS_LABORALES: this.FIXED_VALUES.PRECIO_HORA * (
