...
const calcularSalarioBruto = () => {
	...
	const PLUS_NOCTURNIDAD_8_HORAS = PRECIO_HORA * 0.75 * 0.25;
	const PLUS_NOCTURNIDAD_8_25_HORAS = PRECIO_HORA * 0.25;
	const PLUS_EVENTO = 3;
	...
	const SALARIO_8_HORAS = TURNOS_8_HORAS.value * PRECIO_HORA * 8 + PLUS_NOCTURNIDAD_8_HORAS * TURNOS_8_HORAS.value;
	const SALARIO_8_25_HORAS = TURNOS_8_25_HORAS.value * PRECIO_HORA * 8.25 + PLUS_NOCTURNIDAD_8_25_HORAS * TURNOS_8_25_HORAS.value;
	...
	const SALARIO_BRUTO = SALARIO_4_HORAS + SALARIO_5_HORAS + SALARIO_6_5_HORAS + SALARIO_7_HORAS + SALARIO_8_HORAS + SALARIO_8_25_HORAS + SALARIO_COACHING + SALARIO_FESTIVO + SALARIO_FESTIVO_ESPECIAL + SALARIO_EVENTO + VACACIONES;
